    ...
    <div className="flex flex-wrap gap-2">
      {borders.map((borderName) => (
        <button
          ...
          className="rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold tracking-wide text-slate-700 transition hover:border-slate-900 hover:text-slate-900"
        >
          {borderName}
        </button>
      ))}
